			...
			<h:form>
				<div class="col-md-6 col-md-offset-3">
					...
					<div class="form-group has-error form-group-sm">
						...
						<h2 class="form-signin-heading">Inserisca le credenziali
							fornite dalla clinica</h2>



						<div>
							<font color="#DC143C" size="4">${amministratoreController.errore}</font>
						</div>
						<label for="inputUsername">Username: </label>
						<h:inputText styleClass="form-control"
							value="#{amministratoreController.username}" required="true"
						...
						<h:inputSecret styleClass="form-control"
							value="#{amministratoreController.password}" required="true"
